...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = "primary", size = "md", isLoading, children, disabled, ...props }, ref) => {
        ...
        const variants = {
            ...
            secondary: "bg-white text-gray-700 hover:bg-gray-50 border border-gray-300 focus:ring-blue-500 shadow-sm",
...
/** Fallback class merge utility if not present globally */
